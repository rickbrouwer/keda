...
const FallbackBehaviorAllTriggersFailing = "allTriggersFailing"
...
type Fallback struct {
	...
	// +kubebuilder:validation:Enum=static;currentReplicas;currentReplicasIfHigher;currentReplicasIfLower;allTriggersFailing
